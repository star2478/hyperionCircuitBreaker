...
/**
 * Properties for instances of {@link HyperionThreadPool}.
 * <p>
 ...
 */
public abstract class HyperionThreadPoolProperties {
    ...
    protected HyperionThreadPoolProperties(HyperionThreadPoolKey key) {
        this(key, new Setter(), "hystrix");
    }

    protected HyperionThreadPoolProperties(HyperionThreadPoolKey key, Setter builder) {
        this(key, builder, "hystrix");
    }

    protected HyperionThreadPoolProperties(HyperionThreadPoolKey key, Setter builder, String propertyPrefix) {
    ...
    private static HystrixProperty<Integer> getProperty(String propertyPrefix, HyperionThreadPoolKey key, String instanceProperty, Integer builderOverrideValue, Integer defaultValue) {
        return forInteger()
    ...
    private static HystrixProperty<Boolean> getProperty(String propertyPrefix, HyperionThreadPoolKey key, String instanceProperty, Boolean builderOverrideValue, Boolean defaultValue) {
        return forBoolean()
                .add(propertyPrefix + ".threadpool." + key.name() + "." + instanceProperty, builderOverrideValue)
                .add(propertyPrefix + ".threadpool.default." + instanceProperty, defaultValue)
                .build();
    ...
    /**
     * Duration of statistical rolling window in milliseconds. This is passed into {@link HystrixRollingNumber} inside each {@link HyperionThreadPoolMetrics} instance.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Number of buckets the rolling statistical window is broken into. This is passed into {@link HystrixRollingNumber} inside each {@link HyperionThreadPoolMetrics} instance.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Fluent interface that allows chained setting of properties that can be passed into a {@link HyperionThreadPool} via a {@link HystrixCommand} constructor to inject instance specific property
     * overrides.
     * <p>
