 ...
 */
public abstract class HyperionCommandProperties {
    private static final Logger logger = LoggerFactory.getLogger(HyperionCommandProperties.class);
    ...
    @SuppressWarnings("unused") private final HyperionCommandKey key;
    ...
    protected HyperionCommandProperties(HyperionCommandKey key) {
        this(key, new Setter(), "hystrix");
    }

    protected HyperionCommandProperties(HyperionCommandKey key, HyperionCommandProperties.Setter builder) {
    ...
    protected HyperionCommandProperties(HyperionCommandKey key, HyperionCommandProperties.Setter builder, String propertyPrefix) {
        this.key = key;
    ...
    /**
     * Whether to use a {@link HyperionCircuitBreaker} or not. If false no circuit-breaker logic will be used and all requests permitted.
     * <p>
     ...
     * <p>
     * The error percentage this is compared against comes from {@link HyperionCommandMetrics#getHealthCounts()}.
     * 
    ...
    /**
     * If true the {@link HyperionCircuitBreaker#allowRequest()} will always return true to allow requests regardless of the error percentage from {@link HyperionCommandMetrics#getHealthCounts()}.
     * <p>
    ...
    /**
     * If true the {@link HyperionCircuitBreaker#allowRequest()} will always return false, causing the circuit to be open (tripped) and reject all requests.
     * <p>
    ...
    /**
     * Minimum number of requests in the {@link #metricsRollingStatisticalWindowInMilliseconds()} that must exist before the {@link HyperionCircuitBreaker} will trip.
     * <p>
    ...
    /**
     * The time in milliseconds after a {@link HyperionCircuitBreaker} trips open that it should wait before trying requests again.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Allow a dynamic override of the {@link HyperionThreadPoolKey} that will dynamically change which {@link HyperionThreadPool} a {@link HystrixCommand} executes on.
     * <p>
     * Typically this should return NULL which will cause it to use the {@link HyperionThreadPoolKey} injected into a {@link HystrixCommand} or derived from the {@link HyperionCommandGroupKey}.
     * <p>
     * When set the injected or derived values will be ignored and a new {@link HyperionThreadPool} created (if necessary) and the {@link HystrixCommand} will begin using the newly defined pool.
     * 
    ...
    /**
     * Time in milliseconds to wait between allowing health snapshots to be taken that calculate success and error percentages and affect {@link HyperionCircuitBreaker#isOpen()} status.
     * <p>
    ...
    /**
     * Maximum number of values stored in each bucket of the rolling percentile. This is passed into {@link HystrixRollingPercentile} inside {@link HyperionCommandMetrics}.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Whether percentile metrics should be captured using {@link HystrixRollingPercentile} inside {@link HyperionCommandMetrics}.
     * 
     * @return {@code HystrixProperty<Boolean>}
     */
    ...
    /**
     * Duration of percentile rolling window in milliseconds. This is passed into {@link HystrixRollingPercentile} inside {@link HyperionCommandMetrics}.
     * 
     * @return {@code HystrixProperty<Integer>}
    ...
    /**
     * Number of buckets the rolling percentile window is broken into. This is passed into {@link HystrixRollingPercentile} inside {@link HyperionCommandMetrics}.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Duration of statistical rolling window in milliseconds. This is passed into {@link HystrixRollingNumber} inside {@link HyperionCommandMetrics}.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    /**
     * Number of buckets the rolling statistical window is broken into. This is passed into {@link HystrixRollingNumber} inside {@link HyperionCommandMetrics}.
     * 
     * @return {@code HystrixProperty<Integer>}
     */
    ...
    private static HystrixProperty<Boolean> getProperty(String propertyPrefix, HyperionCommandKey key, String instanceProperty, Boolean builderOverrideValue, Boolean defaultValue) {
        return forBoolean()
    ...
    private static HystrixProperty<Integer> getProperty(String propertyPrefix, HyperionCommandKey key, String instanceProperty, Integer builderOverrideValue, Integer defaultValue) {
        return forInteger()
                .add(propertyPrefix + ".command." + key.name() + "." + instanceProperty, builderOverrideValue)
                .add(propertyPrefix + ".command.default." + instanceProperty, defaultValue)
                .build();
    ...
    private static HystrixProperty<String> getProperty(String propertyPrefix, HyperionCommandKey key, String instanceProperty, String builderOverrideValue, String defaultValue) {
        return forString()
                .add(propertyPrefix + ".command." + key.name() + "." + instanceProperty, builderOverrideValue)
                .add(propertyPrefix + ".command.default." + instanceProperty, defaultValue)
                .build();
    ...
    private static HystrixProperty<ExecutionIsolationStrategy> getProperty(final String propertyPrefix, final HyperionCommandKey key, final String instanceProperty, final ExecutionIsolationStrategy builderOverrideValue, final ExecutionIsolationStrategy defaultValue) {
    ...
    private static final class ExecutionIsolationStrategyHystrixProperty implements HystrixProperty<ExecutionIsolationStrategy> {
        ...
        private ExecutionIsolationStrategyHystrixProperty(ExecutionIsolationStrategy builderOverrideValue, HyperionCommandKey key, String propertyPrefix, ExecutionIsolationStrategy defaultValue, String instanceProperty) {
