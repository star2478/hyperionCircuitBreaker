...
public interface HyperionInvokableInfo<R> {

    HyperionCommandGroupKey getCommandGroup();

    HyperionCommandKey getCommandKey();
...
//    HystrixCollapserKey getOriginatingCollapserKey();
    ...
    HyperionCommandMetrics getMetrics();

    HyperionCommandProperties getProperties();
    ...
    List<HyperionEventType> getExecutionEvents();
