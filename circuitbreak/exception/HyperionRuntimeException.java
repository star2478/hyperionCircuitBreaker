...
import com.pingan.testdemo.circuitbreak.HyperionInvokable;

/**
 * RuntimeException that is thrown when a {@link HystrixCommand} fails and does not have a fallback.
 */
@SuppressWarnings("rawtypes")
public class HyperionRuntimeException extends RuntimeException {

    private static final long serialVersionUID = 5219160375476046229L;

    private final Class<? extends HyperionInvokable> commandClass;
    ...
    public HyperionRuntimeException(FailureType failureCause, Class<? extends HyperionInvokable> commandClass, String message, Exception cause, Throwable fallbackException) {
        super(message, cause);
    ...
    public HyperionRuntimeException(FailureType failureCause, Class<? extends HyperionInvokable> commandClass, String message, Throwable cause, Throwable fallbackException) {
        super(message, cause);
        this.failureCause = failureCause;
        this.commandClass = commandClass;
        this.fallbackException = fallbackException;
     ...
     */
    public Class<? extends HyperionInvokable> getImplementingClass() {
        return commandClass;
    }
