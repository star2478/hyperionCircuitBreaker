 ...
 */
public class HyperionBadRequestException extends RuntimeException {

    private static final long serialVersionUID = -8341452103561805856L;

    public HyperionBadRequestException(String message) {
        super(message);
    }

    public HyperionBadRequestException(String message, Throwable cause) {
        super(message, cause);
    }
}
