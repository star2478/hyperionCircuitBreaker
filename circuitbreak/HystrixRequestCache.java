...
public class HystrixRequestCache {
    ...
    public static HystrixRequestCache getInstance(HyperionCommandKey key, HystrixConcurrencyStrategy concurrencyStrategy) {
     ...
     * <p>
     * We prefix with {@link HyperionCommandKey} or {@link HystrixCollapserKey} since the cache is heterogeneous and we don't want to accidentally return cached Futures from different
     * types.
     * 
    ...
    private static class RequestCacheKey {
        ...
        private RequestCacheKey(HyperionCommandKey commandKey, HystrixConcurrencyStrategy concurrencyStrategy) {
            type = 1;
            if (commandKey == null) {
                this.key = null;
            } else {
