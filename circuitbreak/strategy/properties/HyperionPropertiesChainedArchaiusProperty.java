 ...
 * @ExcludeFromJavadoc
 */
public abstract class HyperionPropertiesChainedArchaiusProperty {
    private static final Logger logger = LoggerFactory.getLogger(HyperionPropertiesChainedArchaiusProperty.class);
