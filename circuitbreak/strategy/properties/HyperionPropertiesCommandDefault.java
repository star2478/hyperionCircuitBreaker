 ...
 * @ExcludeFromJavadoc
 */
public class HyperionPropertiesCommandDefault extends HyperionCommandProperties {

    public HyperionPropertiesCommandDefault(HyperionCommandKey key, Setter builder) {
        super(key, builder);
    }
