 ...
 *
 */
public interface HyperionDynamicProperties {
     ...
     */
    public HyperionDynamicProperty<String> getString(String name, String fallback);
    /**
     * Requests a property that may or may not actually exist.
     * @param name property name, never <code>null</code>
     * @param fallback default value, maybe <code>null</code>
     * @return never <code>null</code>
     */
    public HyperionDynamicProperty<Integer> getInteger(String name, Integer fallback);
    /**
     * Requests a property that may or may not actually exist.
     * @param name property name, never <code>null</code>
     * @param fallback default value, maybe <code>null</code>
     * @return never <code>null</code>
     */
    public HyperionDynamicProperty<Long> getLong(String name, Long fallback);
    /**
     * Requests a property that may or may not actually exist.
     ...
     * @return never <code>null</code>
     */
    public HyperionDynamicProperty<Boolean> getBoolean(String name, Boolean fallback);
    ...
    public static class Util {
        ...
        public static <T> HyperionDynamicProperty<T> getProperty(
                HyperionDynamicProperties properties, String name, T fallback, Class<T> type) {
            return (HyperionDynamicProperty<T>) doProperty(properties, name, fallback, type);
        }
        
        private static HyperionDynamicProperty<?> doProperty(
                HyperionDynamicProperties delegate, 
